...
from question_answering.strategies.facts import FactSimilaritySearch
from question_answering.strategies.keywords import KeywordSearch

class GetCommunities(BaseStrategy):
    def __init__(self, neptune_client, top_n=5, results_accessors=[FactSimilaritySearch, KeywordSearch]):
    ...
    def accept(self, context):
        ...
        for results_accessor in self.results_accessors:
            ids.extend(results_accessor.get_results(context, selector='fact|entity/factId|entityId'))
