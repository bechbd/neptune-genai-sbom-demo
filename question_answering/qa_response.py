...
from common.neptune_utils import get_source_value
...
from question_answering.strategies.chunks import GetChunks
...
class QAResponse():
    def __init__(self, 
                 ...
                 prompt_path='./prompts/answer-question-prompt.txt'):
    ...
    def generate_response(self, context):
        ...
        communities = '\n\n'.join(
            BaseStrategy.get_results(context, GetCommunities, selector='community/value')
        )
        
        facts = '\n\n'.join(
            BaseStrategy.get_results(context, [FactSimilaritySearch, FactExpansion], selector_func=format_fact)
        )
